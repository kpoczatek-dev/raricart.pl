...
?>
    ...
    <div class="background-overlay" id="bg" style="<?php if(isset($gallery_bg) && $gallery_bg) echo "background-image: url('$gallery_bg'); background-size: cover; background-position: center;"; ?>"></div>
